...
<div class="single__header">
	...
	<div class="post__head">
		...
		<?php if( $theme_settings->general['post_navigation'] ): ?>
			...
			<div class="post__navigation">
				...
				<?php
				if( is_rtl() ){
					previous_post_link( '%link',  __('Previous', 'sleek') . '<i class="icon-arrow-right"></i> ' );
					next_post_link( '%link', '<i class="icon-arrow-left"></i>' . __('Next', 'sleek') );
				}else{
					previous_post_link( '%link', '<i class="icon-arrow-left"></i> ' . __('Previous', 'sleek') );
					next_post_link( '%link', __('Next', 'sleek') . ' <i class="icon-arrow-right"></i>' );
				}
