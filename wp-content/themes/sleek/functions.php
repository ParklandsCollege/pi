...
function sleek_load_conditional_scripts() {
	...
	wp_register_script( 'sleek_google_maps', 'http://maps.googleapis.com/maps/api/js?sensor=false&language='.get_locale(), array(), NULL, true );
...
function sleek_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'             => THEME_FRAMEWORK . '/plugins/wp-less.zip', // The plugin source.
