...
<!-- sidebar -->
<aside id="sidebar" class="sidebar <?php echo $sidebar_class; ?>" role="complementary">
	...
	<?php if( $use_tabs ):?>
		<div class="sidebar__tabs hidden-mobile">
			<a href="#" class="active js-sidebar-tab" data-tab="comments"><?php comments_number( __( '0 Comments', 'sleek' ), __( '1 Comment', 'sleek' ), __( '% Comments', 'sleek' ) ); ?></a>
			<a href="#" class="js-sidebar-tab" data-tab="general"><?php echo $theme_settings->general['sidebar_title']; ?></a>
		</div>
	<?php endif; ?>
	<!-- / Sidebar Tabs -->
