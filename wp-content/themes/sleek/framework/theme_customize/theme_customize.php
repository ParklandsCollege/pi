...
function sleek_load_customize_controls_assets($hook_suffix){
	wp_register_style('sleek_customize_control_custom_style', THEME_CUSTOMIZE_URI . '/assets/css/customize_control_custom_style.css', array(), '1.0', 'all');
	wp_enqueue_style('sleek_customize_control_custom_style');

	wp_enqueue_media();

	wp_register_script('sleek_customize_control_custom_script', THEME_CUSTOMIZE_URI . '/assets/js/customize_control_custom_script.js', array('jquery'), '1.0.1', 'all', true);
...
include_once('customize_controls/image_upload.php');
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		'post_navigation',
		array(
			'label'		=> __( 'Use Post Navigation', 'sleek' ),
			'section'	=> 'general_settings',
...
$wp_customize->add_section( 'typography_settings', array(
	'title'		=> __('Typography Settings', 'sleek'),
	'priority'	=> 50,
...
$wp_customize->add_section( 'bloging_settings', array(
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home: Use Sidebar', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home: Use Title Header', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		'blog_home_title',
		array(
			'label'		=> __( 'Blog Home: Title', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home: Title Above', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home: Description', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new Bg_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home: Title Header Background', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home: Title Header Background is Light', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home Posts: Title', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home Posts: Title Above', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home Posts: Display Style', 'sleek' ),
			'section'	=> 'bloging_settings',
...
$wp_customize->add_control(
	new WP_Customize_Control($wp_customize,
		...
		array(
			'label'		=> __( 'Blog Home Posts: Pagination Type', 'sleek' ),
			'section'	=> 'bloging_settings',
...
// Blog Home Featured Display Style
